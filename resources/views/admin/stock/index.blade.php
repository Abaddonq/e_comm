...
<div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
    ...
    <button onclick="showAdjustModal()" class="inline-flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-4 rounded min-h-[44px]">
        Adjust Stock
    </button>
</div>

<div class="bg-white shadow rounded-lg mb-6">
    <form method="GET" action="{{ route('admin.stock.index') }}" class="p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
        ...
        <label class="flex items-center lg:col-span-3">
        ...
        <a href="{{ route('admin.stock.index') }}" class="inline-flex items-center justify-center text-gray-600 hover:text-gray-800 px-4 min-h-[44px] w-full lg:w-auto lg:col-span-1">
            Clear
        </a>
    </form>
</div>
...
<div id="adjustModal" class="fixed inset-0 z-50 bg-gray-900/50 hidden">
    <div class="flex min-h-full items-end md:items-center justify-center">
    <div class="w-full bg-white rounded-t-2xl md:rounded-md shadow-lg md:max-w-2xl max-h-[92vh] overflow-y-auto p-4 sm:p-5">
        ...
        <form method="POST" action="{{ route('admin.stock.adjust') }}">
            @csrf
            <div id="adjustmentsContainer" class="space-y-4 max-h-[55vh] overflow-y-auto pr-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 adjustment-row">
                    <div class="col-span-1">
            ...
            <div class="mt-6 flex flex-col-reverse sm:flex-row justify-end gap-3">
                <button type="button" onclick="hideAdjustModal()" class="text-gray-600 hover:text-gray-800 px-4 min-h-[44px]">
                    Cancel
                </button>
                <button type="submit" class="bg-indigo-600 text-white px-6 rounded hover:bg-indigo-700 min-h-[44px]">
                    Adjust Stock
                </button>
            </div>
        </form>
